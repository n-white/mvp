...
angular.module('reviewCloudApp.reviewCloud', ['reviewCloudApp.searchPlaces'])
	.controller('ReviewCloudController', function($scope, $state, $http, searchId) {
	    ...
	    var color = d3.scale.linear()
	            ...
	            .range(["#676767", "#676767", "#676767", "#00cc66", "#00cc66", "#00cc66", "#3333cc", "#3333cc", "#3333cc", "#9900cc", "#9900cc", "#9900cc"]);
		...
		'no','hey','hi','hello','ah','extremely','with','being','said','anywhere','definitely','because','than','place','restaurant']
